...
import { ClientComponent, EmailDialogComponent, EmailFolderDialogComponent, TaskDialogComponent, LinkTaskDialogComponent, TasksComponent, ContextComponent, EmailDetailedViewComponent, EmailListComponent } from './'; // all intelligent components
